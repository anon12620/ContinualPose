...
from_mpii_mapping = [
    (13, 5), (12, 6), (14, 7), (11, 8), (15, 9),
    (10, 10), (3, 11), (2, 12), (4, 13), (1, 14),
    (5, 15), (0, 16), (6, 17), (7, 18), (8, 19), (9, 20),
]

from_crowdpose_mapping = [
    (0, 5), (1, 6), (2, 7), (3, 8), (4, 9),
    (5, 10), (6, 11), (7, 12), (8, 13), (9, 14),
    (10, 15), (11, 16), (12, 20), (13, 19)
]

to_coco_mapping = [(dst, src) for src, dst in from_coco_mapping]
to_mpii_mapping = [(dst, src) for src, dst in from_mpii_mapping]
to_crowdpose_mapping = [(dst, src) for src, dst in from_crowdpose_mapping]
...
dataset_crowdpose = dict(
    ...
    pipeline=[
        dict(type='KeypointConverter2',
             num_keypoints=21,
             mapping=from_crowdpose_mapping)
    ],
)
...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        metainfo=dict(from_file='projects/pulse/pulse/datasets/coco21.py'),
        datasets=[dataset_coco, dataset_mpii, dataset_crowdpose],
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        metainfo=dict(from_file='projects/pulse/pulse/datasets/coco21.py'),
        datasets=[dataset_coco_val, dataset_mpii_val, dataset_crowdpose_val],
...
val_evaluator = dict(
    ...
    converters=[
        dict(type='KeypointConverter2',
             num_keypoints=17,
             mapping=to_coco_mapping),
        dict(type='KeypointConverter2',
             num_keypoints=16,
             mapping=to_mpii_mapping),
        dict(type='KeypointConverter2',
             num_keypoints=14,
             mapping=to_crowdpose_mapping)
    ]
)
