...
val_evaluators = [
    ...
    dict(type='UnifiedDatasetEvaluator',
         metrics=[crowdpose_metric, mpii_metric],
         datasets=[dataset_crowdpose_val, dataset_mpii_val],
         converters=[None, mpii_converter]),

    # experience 3 (model predicts 21 keypoints, validate on 14, 16, 17 keypoints)
    dict(type='UnifiedDatasetEvaluator',
         metrics=[crowdpose_metric, mpii_metric, coco_metric],
         datasets=[dataset_crowdpose_val, dataset_mpii_val, dataset_coco_val],
         converters=[None, mpii_converter, None]),
]
